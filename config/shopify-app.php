...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Auction App'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '7bf86dc2bf30bdd99ff2666c99e07195'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '6cc070c7a419199b3c29ac563369004b'),
    'shop_url' => env('SHOPIFY_SHOP_URL','76c14a-0b.myshopify.com'),
    'access_token' => env('SHOPIFY_ACCESS_TOKEN','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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_users,read_orders,write_orders'),
    ...
    */
    ...
    'myshopify_domain' => env('SHOPIFY_MYSHOPIFY_DOMAIN', 'oneauctionhouse.com'),
