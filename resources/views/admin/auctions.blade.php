        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <p style="text-align:right;"><a href="{{ url('auctions/new') }}" class="btn btn-primary">Create New</a></p>
      ...
      /*Delete*/
			jQuery(document).on('click','.btn-delete',function() {
				...
				jQuery.ajax({
					type: "DELETE",
					dataType: "json",
					url: BASE_URL+'/auctions/delete/'+jQuery(this).data('id'),
					data: {},
					beforeSend: function() {},
