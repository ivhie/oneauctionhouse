          ...
          <div class="card">
            <div class="card-body">
             ...
             ?>
              ...
              <form class="row g-3" action="{{url('/unfulfilled-auctions/store')}}" id="fulfillmentform" method="post" enctype="multipart/form-data">
              @csrf
                          ...
                          <div class="accordion-body">
                              <p style="font-style:italic;color:#504e4ef7;"><strong>Description:</strong> The seller confirms they have shipped the item to the authentication center and gives the FedEx tracking number. The admin checks the tracking and updates the status.</p>
                               ...
                               <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                  <input type="text"  value="<?php echo isset($page['fulfillment']->step2_shipping_date)?$page['fulfillment']->step2_shipping_date:'';?>" name="step2_shipping_date" id="step2_shipping_date" class="form-control" placeholder="Date">
                                </div>
                              </div>
                              <div class="row mb-3">
                                <label for="inputText" class="col-sm-4 col-form-label"><strong>FedEx tracking number:</strong></label>
                                <div class="col-sm-8">
                              ...
                              <div class="row mb-3">
                                <label for="inputText" class="col-sm-4 col-form-label"><strong>Tacking Status:</strong></label>
                                
                               
                                <?php $step2_fedx_tracking_status =   isset($page['fulfillment']->step2_fedx_tracking_status)?$page['fulfillment']->step2_fedx_tracking_status:'';?>
                               
                                   <?php // echo $step2_fedx_tracking_status; ?>
                                <div class="col-sm-8">
                                  <select class="form-select" name="step2_fedx_tracking_status" aria-label="Default select example">
                                    <option selected="">Select status</option>
                                    <option value="Inprogress" <?php echo ($step2_fedx_tracking_status=='Inprogress')?'selected':'';?>>Inprogress</option>
                                    <option value="Arrived" <?php echo ($step2_fedx_tracking_status=='Arrived')?'selected':'';?>>Arrived</option>
                                  </select>
                                </div>
                              </div>
                        ...
                        <div id="collapse5" class="accordion-collapse collapse <?php echo $collapse5;?>" aria-labelledby="heading5" data-bs-parent="#accordionExample">
                          <div class="accordion-body">
                              ...
                              <div class="row mb-3">
                                ...
                                <?php $step5_buyer_payment =  isset($page['fulfillment']->step5_buyer_payment)?$page['fulfillment']->step5_buyer_payment:'';?>
                                <div class="col-sm-8">
                                  <select class="form-select"  name="step5_buyer_payment" aria-label="Default select example">
                          ...
                          <div class="accordion-body">
                           <p style="font-style:italic;color:#504e4ef7;"><strong>Description:</strong> The seller confirms they have received the payment. The admin checks the payment confirmation and updates the status, getting ready for the last stage.</p>
                              ...
                              <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                  <?php $step6_payment_received =  isset($page['fulfillment']->step6_payment_received)?$page['fulfillment']->step6_payment_received:'';?>
                                  <select class="form-select" name="step6_payment_received" aria-label="Default select example">
                                    <option selected="">Status</option>
                                    <option value="Yes" <?php echo ($step6_payment_received=='Yes')?'selected':'';?>>Yes</option>
                                    <option value="No" <?php echo ($step6_payment_received=='No')?'selected':'';?>>No</option>
                                  </select>
                                </div>
                              </div>
                              <div class="row mb-3">
