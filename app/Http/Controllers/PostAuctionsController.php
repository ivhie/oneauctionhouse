...
class PostAuctionsController extends Controller
{
    ...
    public $b;
     ...
     public function __construct(ShopifyService $shopifyService, AuctionItems $lot, Bidders $bidders,Bidders $bidder  )
     {
       ...
       public function new($id=null){
             ...
             $page = array(
                 'menu'=>'post',
                 'page_title'=>'Post Auction Listing',
                 'subtitle'=>'Post Auction Entry',
                 'status'=>'post',
             ...
             return view('admin.post-auctions-new')->with('page',$page);
       ...
       public function get(){
         ...
         $auctions->where('product_status','=','post');
         ...
         $auctions2->where('product_status','=','post');
       ...
       public function AddAuctionToLaravelDB(Request $request) {
             ...
             if( $item->save() ){ // success
                 ...
                 if(request()->submitedfrom == 'laravel'){ //submitted from laravel
                     return redirect('/post-auctions/edit/'.$item->id)->with('added', $sucess_msg);
                 } else {
                     //submitted from shopify
                 ...
                 if(request()->submitedfrom == 'laravel'){ //submitted from laravel
                     return redirect('/post-auctions')->with('failed', 'New item failed to add!');
                 } else {
                     //submitted from shopify
        ...
        public function index(){
            ...
            $page = array(
                'menu'=>'post',
                'count'=>'post',
                'page_title'=>'Post Auctions',
                'subtitle'=>'Post Items',
                'status'=>'post',
            );

            return view('admin.post-auctions')->with('page',$page);
        }
