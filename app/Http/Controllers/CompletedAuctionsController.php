...
class CompletedAuctionsController extends Controller
{
    ...
    public $b;
     ...
     public function __construct(ShopifyService $shopifyService, AuctionItems $lot, Bidders $bidders,Bidders $bidder  )
     {
       ...
       public function new($id=null){
             ...
             $page = array(
                 'menu'=>'completed',
                 'page_title'=>'Completed Auction Listing',
                 'subtitle'=>'Completed Auction Entry',
                 'status'=>'Completed',
             ...
             if($id){
                 ...
                 $page['product_url2'] = '<a  style="margin-top:8px;display:block;" href="//'.env("SHOPIFY_STORE_BACKEND_ADMIN").'/products/'.$auction->product_id.'" target="_blank" class="btn btn-warning">View Auction Admin</a>'; 
             ...
             return view('admin.completed-auctions-new')->with('page',$page);
       ...
       public function get(){
         ...
         $auctions->where('product_status','=','completed');
         ...
         $auctions2->where('product_status','=','completed');
       ...
       public function AddAuctionToLaravelDB(Request $request) {
             ...
             if( $item->save() ){ // success
                 ...
                 if(request()->submitedfrom == 'laravel'){ //submitted from laravel
                     return redirect('/completed-auctions/edit/'.$item->id)->with('added', $sucess_msg);
                 } else {
                     //submitted from shopify
                 ...
                 if(request()->submitedfrom == 'laravel'){ //submitted from laravel
                     return redirect('/completed-auctions')->with('failed', 'New item failed to add!');
                 } else {
                     //submitted from shopify
        ...
        public function index(){
            ...
            return view('admin.completed-auctions')->with('page',$page);
        }
