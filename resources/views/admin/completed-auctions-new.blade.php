...
.select2-container--default .select2-selection--single .select2-selection__rendered {
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Completed Auctions</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    ...
    @endif
        ...
        <div id="display_success_msg" class="alert alert-success bg-success text-light border-0 alert-dismissible fade" role="alert">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" id="submitform" action="" method="post" enctype="multipart/form-data">
              @csrf
                <h3>LOT NUMBER : #<?php echo isset($page['auction']->watch_lot_id)?$page['auction']->watch_lot_id: ''; ?> </h3>
                
                <div id="display_errors_here"></div>
                <div class="row">
                    <div class="col-md-4">
                      ...
                      <div class="form-floating mb-3">
                       <?php 
                          ...
                          //echo $product_status;
                       ?>
                        <select class="form-select product_status @error('product_status') is-invalid @enderror" id="floatingStatus" name="product_status" aria-label="Package" required>
                      ...
                      <div class="form-floating mb-3">
                        ...
                        <input type="text" name="watch_model_number" value="<?php echo isset($page['auction']->watch_model_number)?$page['auction']->watch_model_number: old('watch_model_number'); ?>" class="form-control watch_model_number @error('watch_model_number') is-invalid @enderror" id="floatingListingModel" placeholder="Model Number">
                      ...
                      <div class="form-floating mb-3">
                        <input type="text" name="year_of_watch" value="<?php echo isset($page['auction']->year_of_watch)?$page['auction']->year_of_watch: old('year_of_watch'); ?>" class="form-control year_of_watch @error('year_of_watch') is-invalid @enderror" id="floatingListingYear" placeholder="Year of Watch" required>
                      ...
                      <?php 
                       ...
                       ?>
                      <div class="form-floating mb-3">
                        <select class="form-select watch_package @error('watch_package') is-invalid @enderror" id="floatingPackage" name="watch_package" aria-label="Package" required>
                      ...
                      <?php if( $watch_package == 'Yes Reserve Auction'  ) {
                        
                                $reserve_show = "style='display:block;'";
                        } else { 

                                $reserve_show = "style='display:none;'";
                        } ?>
                      <div class="form-floating mb-3"  id="reserve_wrapper" <?php echo  $reserve_show; ?> >
                        <input type="text" name="watch_reserve" value="<?php echo isset($page['auction']->reserves)?$page['auction']->reserves: ''; ?>" class="form-control watch_reserve @error('watch_reserve') is-invalid @enderror" id="floatingListingwatch_reserve" placeholder="Reserve">
                      ...
                      <?php 
                       ...
                       ?>
                      <div class="form-floating mb-3">
                        <select class="form-select watch_papers @error('watch_papers') is-invalid @enderror" name="watch_papers" id="floatingWatchPapers" aria-label="WatchPapers" required>
                        ...
                        <label for="floatingWatchPapers">Do you have the watch papers?</label>
                      ...
                      <?php 
                          ...
                          //echo $product_status;
                       ?>
                        <select class="form-select watch_box @error('watch_box') is-invalid @enderror" name="watch_box" id="floatingWatchBox" aria-label="WatchBox" required>
                      ...
                      <?php 
                       ...
                       ?>
                        ...
                        <select class="form-select watch_after_market @error('watch_after_market') is-invalid @enderror" name="watch_after_market" id="floatingWatchBox" aria-label="watch_after_market" required>
                      ...
                      <div class="form-floating mb-3">
                          <input type="text" name="watch_condition" value="<?php echo isset($page['auction']->watch_condition)?$page['auction']->watch_condition: ''; ?>" class="watch_condition form-control @error('watch_condition') is-invalid @enderror" id="floatingAfterMarket" placeholder="">
                      <?php 
                      ...
                      <div class="form-floating mb-3">
                        <input type="text" name="item_location" value="<?php echo isset($page['auction']->item_location)?$page['auction']->item_location: ''; ?>" class="form-control item_location @error('item_location')' is-invalid @enderror" id="floatingListingitem_location" placeholder="Item Location" required>
                        <label for="floatingListingitem_location">Location</label>
                        @if($errors->has('item_location'))
                            <div class="invalid-feedback" style="display:block;">{{ $errors->first('item_location') }}</div>
                        @endif
                      </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-floating mb-3">
                        <input type="date" name="bidding_date" value="<?php echo isset($page['auction']->bidding_date)?$page['auction']->bidding_date:''; ?>" class="form-control bidding_date @error('bidding_date') is-invalid @enderror" id="floatingListingBiddingDate" placeholder="10/07/2024" required />
                        <label for="floatingListingBiddingDate">Schedule Bid End Date (dd/mm/yyyy)</label>
                        @if($errors->has('bidding_date'))
                            <div class="invalid-feedback" style="display:block;">{{ $errors->first('bidding_date') }}</div>
                        @endif
                      </div>
                      <div class="form-floating mb-3">
                        <input type="time" name="bidding_time" value="<?php echo isset($page['auction']->bidding_time)?$page['auction']->bidding_time: ''; ?>" class="form-control bidding_time @error('bidding_time') is-invalid @enderror" id="floatingListingBiddingTime" placeholder="12:30PM" required />
                      ...
                      <div class="form-floating mb-3">
                        <input type="text" name="bidding_title" value="<?php echo isset($page['auction']->bidding_title)?$page['auction']->bidding_title: ''; ?>" class="form-control bidding_title @error('bidding_title') is-invalid @enderror" id="floatingListingBiddingTitle" placeholder="Title" required />
                      ...
                      <div class="form-floating" >
                        <textarea class="form-control yyytinymce-editor11 @error('bidding_description') is-invalid @enderror" name="bidding_description" placeholder="Bidding Description" id="bidding_description" style="height: 150px;"><?php echo isset($page['auction']->bidding_description)?$page['auction']->bidding_description: ''; ?></textarea>
                        ...
                        <script type="module">
                          ...
                          ClassicEditor
                            .create( document.querySelector( '#bidding_description' ), {
                 ...
                 <?php  if( 
                       ...
                       <p><a href="<?php echo url('/pending-approvals/download/'.$page['auction']->watch_lot_id); ?>">Download All Images</a></p>
                 <?php
                } ?>
                      
                     <?php  if( isset($page['watch_photos_urls']) &&  $page['watch_photos_urls'] != null) { 
                            
                           // var_dump($page['watch_photos_urls']);
                       ...
                       ?>
                          ...
                          <script type="text/javascript">
                            ...
                            $("#floatingPackage").change(function () {
                                var reserve = this.value;
                                if ( reserve == 'No Reserve Auction' ) {
                                    $('#reserve_wrapper').css('display','none');
                                }else {
                                      $('#reserve_wrapper').css('display','block');
                                }
                    ...
                    <div class="col-md-4">
                      ...
                      <?php if(isset($page['auction']->id)) { ?>
                        <div class="form-control  mb-3" style="padding: 20px 10px;">
                          ...
                          <button type="button" style="display:block;width:100%;" class="btn btn-primary" id="save-auction">Save And Publish</button>
                          <?php if(isset($page['auction']->product_id)) { ?>
                            <!--<a href="#"  style="margin-top:8px; display:block;" id="update_publish_auction" data_id="<?php echo $page['auction']->id; ?>" class="btn btn-primary">Update Publish</a>-->
                            <?php echo ($page['product_url']);?>
                            <?php echo ($page['product_url2']);?>
                            <?php } else { ?>
                           <!-- <a href="#"  style="margin-top:6px;" id="publish_auction" data_id="<?php echo $page['auction']->id; ?>" class="btn btn-primary">Save And Publish</a>-->
                            <!--<a href="#" style="display:none;margin-top:8px;" id="update_publish_auction" data_id="<?php echo $page['auction']->id; ?>" class="btn btn-primary">Update Publish</a>-->
                            <a href="#" style="display:none;margin-top:8px;" id="shopify_product_url" target="_blank" class="btn btn-warning">View Auction Shopify</a>
                            <a href="#" style="display:none;margin-top:8px;" id="shopify_product_admin_url"  target="_blank" class="btn btn-warning">View Auction Admin</a>
  ...
  <script>
     ...
     /* Ajax */
      // make auction goes live
        ...
        jQuery('#save-auction').click(function(e){


         //get data for check editor
          //var content = $('#bidding_description').data('ckeditorInstance').getData();
          const content = editor.getData();
          jQuery("#bidding_description").val(content);
         // alert(content);



          jQuery("#display_success_msg").removeClass('show');
          e.preventDefault();
				  jQuery('#display_errors_here .alert').remove();
          jQuery('.form-control').removeClass('is-invalid');
				  
				  jQuery("#save-auction").text('loading....');
           ...
           let formData = new FormData(document.getElementById("submitform"));
				   ...
				   jQuery.ajax({
					  url: BASE_URL+'/completed-push-auction-live/save',
					  method: 'post',
					  data: formData,
            contentType: false,
		        processData: false,
					  success: function(jsonData){
					       jQuery("#save-auction").text('Save And Publish');
                ...
                if ( data.status=='failed' ) {
                  ...
                  jQuery("#display_success_msg").addClass('show');
                  jQuery("#display_success_msg").text(data.msg);

                  jQuery("#shopify_product_url").css('display','block');
                  jQuery("#shopify_product_admin_url").css('display','block');
                  jQuery("#shopify_product_url").attr('href',data.shopify_product_url);
                  jQuery("#shopify_product_admin_url").attr('href',data.shopify_product_admin_url);

                  
                  if(data.upload_image_urls){

                    // reset images view
                    jQuery('.popup-gallery').html('');
                    
                    urls = data.upload_image_urls
                    const img_urls = urls.split(",");
                    let count_url = img_urls.length;

                    for(j=0; j<count_url;j++){
                      jQuery("<a href='https://z9j.9f8.mytemp.website/public/watches/lot-"+data.lotId+"/"+img_urls[j]+"' title='Lot Number "+data.lotId+"'><img src='https://z9j.9f8.mytemp.website/public/watches/lot-"+data.lotId+"/"+img_urls[j]+"' width=\"75\" height=\"75\" /></a>").appendTo('.popup-gallery');

                    }


                  }
                  //console.log(data.upload_image_urls+'uploaded images');
            ...
            //console.log(data);
              jQuery.each(errors['errors'],function(e,v){
                jQuery('#display_errors_here').prepend('<div class="alert alert-danger">'+v+'</div>');
      ...
      jQuery('#publish_auction').click(function(e){
          ...
          e.preventDefault();
				  ...
				  jQuery.ajaxSetup({
				   ...
				   jQuery.ajax({
					  url: BASE_URL+'/pending-push-auction-live/',
					  method: 'post',
            data: jQuery('#auctionForm').serialize(),
                 ...
                 jQuery("#shopify_product_url").css('display','block');
                 jQuery("#shopify_product_admin_url").css('display','block');
                 jQuery("#shopify_product_url").attr('href',jsonData.shopify_product_url);
                 jQuery("#shopify_product_admin_url").attr('href',jsonData.shopify_product_admin_url);
        ...
        */
        ...
        jQuery('#update_publish_auction').click(function(e){
          ...
          jQuery.ajax({
            url: BASE_URL+'/pending-update-auction-live/'+$(this).attr('data_id'),
            method: 'GET',
            data: '',
          // data: {  id: $(this).attr('data_id') },
            success: function(jsonData){
              ...
              if ( jsonData.status=='failed' ) {
                ...
                //jQuery('#user-form').modal('hide');
                //datatable.ajax.reload();
                jQuery("#display_success_msg").text(jsonData.msg);
              }
